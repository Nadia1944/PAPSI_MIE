...
Public Class Report_Produksi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Main_Menu.Report Produksi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReport_Produksi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_Produksi = New Report_Produksi()
        rpt.Site = Me.Site
        Return rpt
    End Function
